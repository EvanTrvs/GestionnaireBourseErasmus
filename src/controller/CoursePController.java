 ...
 */
public class CoursePController {
	...
	@FXML
	private TableColumn<Integer, String> courseIDColumn;
	 ...
	 */
	public CoursePController(GestionnaireErasmus appli, GridPanController parent) {
		this.parent = parent;
		this.appli = appli;
	}
...
/*
	 ...
	 */
	public void addCourseP(ActionEvent event) throws IOException {
		/*
