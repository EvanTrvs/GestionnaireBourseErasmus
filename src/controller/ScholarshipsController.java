...
public class ScholarshipsController {
	...
	@FXML
	private TableColumn<Integer, String> availableColumn;

	@FXML
	private TableColumn<Integer, String> destinationColumn;
	
	@FXML
	private TableColumn<Integer, String> CRUD;

	@FXML
	private TableColumn<Integer, Float> teacherColumn;
	 ...
	 */
	public ScholarshipsController(GestionnaireErasmus appli, GridPanController parent) {
		this.parent = parent;
		this.appli = appli;
	}
...
/*
	 ...
	 */
	public void addScholarships(ActionEvent event) throws IOException {
		/*
