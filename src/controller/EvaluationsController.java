...
public class EvaluationsController {
	...
	@FXML
	private TableColumn<Integer, String> etuNumColumn;

	@FXML
	private TableColumn<Integer, String> scholIdColumn;
	
	@FXML
	private TableColumn<Integer, String> CRUD;

	@FXML
	private TableColumn<Integer, Float> stateColumn;
	 ...
	 */
	public EvaluationsController(GestionnaireErasmus appli, GridPanController parent) {
		this.parent = parent;
		this.appli = appli;
	}
